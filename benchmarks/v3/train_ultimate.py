...
# PIPELINE FUNCTIONS
# =============================================================================
def train_model(model, name, train_data, steps=5000, micro_batch=1, accum_steps=12, seq_len=4096, lr=4e-4):
...
if __name__ == "__main__":
    ...
    # Using the Stable V2 LR (4e-4) with 5000 steps and 4096 Context
    hgdm_history, hgdm_time = train_model(
        hgdm_model, "HGDMUltimate", train_data, 
        steps=5000, seq_len=4096, lr=4e-4
    )
