...
# PIPELINE FUNCTIONS
# =============================================================================
def train_model(model, name, train_data, steps=1000, micro_batch=1, accum_steps=12, seq_len=2048):
    ...
    for step in range(steps + 1):
        ...
        try:
            for _ in range(accum_steps):
                ...
                # THERMAL THROTTLE: Option 2 (Minimal constant break)
                time.sleep(0.01)
        ...
        if step % 50 == 0:
            ...
            try:
                ...
                if curr_temp > 85:
                    print(f"[THERMAL CONTROL] GPU hit {curr_temp}C. Sleeping 5 seconds to cool down...")
                    time.sleep(5)
            except:
                pass
...
if __name__ == "__main__":
    ...
    hgdm_history, hgdm_time = train_model(hgdm_model, "HGDMUltimate", train_data)
